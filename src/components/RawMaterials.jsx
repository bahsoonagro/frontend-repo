    ...
    <div className="max-w-6xl mx-auto p-6 bg-white rounded shadow">
      ...
      {activeTab === "bulk" && (
        <form onSubmit={handleBulkSubmit} className="space-y-4">
          ...
          <textarea rows="8" value={bulkJson} onChange={e => setBulkJson(e.target.value)} placeholder='Paste JSON array here...' className="border p-2 w-full font-mono" />
        ...
        <div>
          ...
          <table className="w-full border text-sm">
            <thead className="bg-gray-100">
              <tr>
                <th className="border p-2">Type</th><th className="border p-2">Date</th>
                <th className="border p-2">Weight (Kg)</th><th className="border p-2">Damaged</th>
              </tr>
            </thead>
            <tbody>
              {crops.map((c) => (
      ...
      {activeTab === "lpo" && (
        <div>
          ...
          <table className="w-full border text-sm">
            <thead className="bg-gray-100">
              <tr>
                <th className="border p-2">Material</th><th className="border p-2">Year</th>
                <th className="border p-2">Quantity</th><th className="border p-2">Unit Price</th>
                <th className="border p-2">Payment</th><th className="border p-2">Supplier</th>
