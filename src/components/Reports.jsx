...
const Reporting = ({ apiUrl }) => {
  ...
  const tabConfig = [
    { label: "Raw Materials", endpoint: "/raw-materials" },
    { label: "Finished Products", endpoint: "/finished-products" },
    { label: "Stock Movements", endpoint: "/stock-movements" },
    { label: "LPOs & Requisitions", endpoint: "/raw-materials/lpo" },
    { label: "Customer Deliveries", endpoint: "/dispatch-delivery" },
  ];
